                                      ...
                                      $message .= '* {';
                                        ...
                                        $message .= 'a[x-apple-data-detectors="true"] {';
                                          ...
                                          $message .= '<!--[if !mso]><!--><link href="https://fonts.googleapis.com/css?family=Lato:400,700&display=swap" rel="stylesheet" type="text/css"><!--<![endif]-->';
                                            ...
                                            $message .= 'Hello Kamonya,</strong></p>';
                                            $message .= '</div>';
                                            ...
                                            $message .= ' <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;">You have successfully booked x tickets for EventName. </span></p>';
