...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Edit Event | Laugh Industry</title>
                ...
                <div class="card-style mb-30">
                  ...
                  <?php foreach ($event as $item) :?>
                    ...
                    <div class="input-style-1">
                      ...
                      <input type="text" placeholder="Event Name" id ="EventName" value = "<?php echo $item['EventName'];?>"/>
                    </div>
                    
                  <div class="input-style-1">
                    <label>Event Description</label>
                    <textarea placeholder="Event Description" rows="5" id = "EventDescription"><?php echo $item['EventDescription'];?> </textarea> 
                  </div>
                    <div class="input-style-1">
                      <label>Location</label>
                      <input type="text" placeholder="Location" id ="Location" value = "<?php echo $item['Location'];?>"/>
                    </div>

                    <div class="input-style-1">
                      <label>Date</label>
                      <input type="date" id ="Date" value = "<?php echo $item['Date'];?>"/>
                    </div>
                    <!-- end input -->
                    ...
                    <div class="input-style-1">
                      ...
                      <input type="text" placeholder="VIP Capacity" id ="VIPCapacity" value = "<?php echo $item['VIPCapacity'];?>" />
                    </div>
                    <div class="input-style-1">
                    ...
                    <div class="input-style-1">
                      ...
                      <input type="text" placeholder="VIP Ticket Cost" id ="VIPTicketCost" value = "<?php echo $item['VIPTicketCost'];?>" />
                    </div>
                    
                  <div class="input-style-1">
                      <label>Regular Ticket Cost</label>
                      <input type="text" placeholder="Regular Ticket Cost" id ="RegularTicketCost" value = "<?php echo $item['RegularTicketCost'];?>" />
                    </div>
